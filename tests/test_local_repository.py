...
def test_fetch_existing_draw_nos_returns_existing_values(tmp_path: Path) -> None:
    repo = LocalLotoRepository(
        base_path=str(tmp_path),
        table_loto6="loto6_history",
        table_loto7="loto7_history",
    ...
    repo.import_rows(
        "loto6",
        [
            {"draw_no": 2001, "n1": 1, "n2": 2, "n3": 3, "n4": 4, "n5": 5, "n6": 6},
            {"draw_no": 2002, "n1": 7, "n2": 8, "n3": 9, "n4": 10, "n5": 11, "n6": 12},
        ],
    )

    existing_draw_nos = repo.fetch_existing_draw_nos("loto6", [2001, 2003])

    assert existing_draw_nos == {2001}
